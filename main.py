...
filename = 'bns_tilde_example_data0_1126259642-413_analysis_H1L1V1_result'
...
print(plot_title)
plotter.plot(save=True, show=False, xlabel=parameters[0], ylabel=parameters[1], title=plot_title)
